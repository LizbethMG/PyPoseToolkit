...
class Experiment:
    ...
    def get_point_positions(self):
        ...
        excel_files = glob2.glob(os.path.join(self.path_to_experiment, '*.xlsx'))
            ...
            try:
                ...
                with pd.ExcelFile(file_path) as xls:
                    ...
                    if rows_point < rows_bodypart:
                        ...
                        print(
                            f"       The point_positions DataFrame is already longer or equal in rows compared to bodypart_positions.")
